...
public class TmplUpdateAPI {
    ...
    public static void main(String[] args) {
        ...
        req.setTemplateExtra("string");
        req.setTemplateAd("string");
        ...
        try {
            ...
            HttpPost postReq = new HttpPost("https://api.msghub.uplus.co.kr/kko/v1/senderkey/template/update");
